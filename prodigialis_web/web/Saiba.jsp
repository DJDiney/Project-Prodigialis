...
<body style="font-family:Oswald">
    ...
    <div class="parallax-container" style="height:15.3%">

        <div class="parallax"><img src="Imagens/triangulo.png"></div>
    ...
    <div class="section white">
        ...
        <div class="row container">
            ...
            <h3 class="header col s6">Saiba Mais</h3>
        ...
        <div class="row container">
            ...
            <p style= "font-size: 20px">
                O Prodigialis RH é um sistema pensado e montado para o Trabalho de Conclusão de Curso (TCC), 
                do curso de Informática do CEFET-MG do nosso grupo composto por 5 pessoas.
                Buscamos desde o começo desenvolver um sistema eficiente e profissional, 
                capaz de atender o que cumpre. Esperamos que todos se sintam satisfeitos com o Prodigialis RH.
            </p>
    ...
    <div class="parallax-container" style="height:25.6%">

        <div class="parallax"><img src="Imagens/triangulo.png"></div>

    </div> 	

    <footer class="page-footer" style="background-color:#047A78; margin:0px">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col l6 s12">
                    ...
                    <p class="grey-text text-lighten-4">Serviço RH com qualidade e segurança</p>
                ...
                <div class="col l4 offset-l2 s12">
                    ...
                    <ul>
                        ...
                        <li><a class="grey-text text-lighten-3" href="Sobre.html">Sobre a Empresa</a></li>
                        <li><a class="grey-text text-lighten-3" href="Saiba.html">Saiba Mais</a></li>
