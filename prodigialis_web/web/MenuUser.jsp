                            ...
                            <li>
								...
								<div class="dropdown">
								  ...
								  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
									...
									<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Informa�aões da conta</a></li>
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
				Informações da sua conta foram atualizadas!
		  </div>
	...
	<div class="modal fade" id="ModalVerProcessoSeletivo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h4 class="modal-title" id="myModalLabel">Currículo enviado </h4>
		  </div>
		  <div class="modal-body">
				Seu currículo foi enviado para a equipe encarregada deste processo seletivo e sua aprovação está pendente pela staff de Prodigialis
		  </div>
		  <div class="modal-footer">
			<div class="center" style="vertical-align:center;padding-bottom:20px;">
				<button type="button" data-dismiss="modal" class="btn btn-success btn-simple">Ok!</button>
