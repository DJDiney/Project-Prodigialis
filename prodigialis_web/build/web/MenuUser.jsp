                            ...
                            <li>
								...
								<div class="dropdown">
								  ...
								  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
									...
									<li role="presentation"><a role="menuitem" tabindex="-1" href="#">InformaÁa√µes da conta</a></li>
		...
		<div class="container">	
			...
			<div class="row" id="proc" >
				...
				<div class="form-group col-md-4 ">
					...
					<input disable value="N∫ de Vagas" id="nvaga" type="text" class="form-control">
				</div>
			...
			<div class="row">
				...
				<div class="form-group col-md-6 ">
					...
					<input disable value="InÌcio" id="datin" type="text" class="form-control">
			...
			<div class="row">
				<div class="form-group col-md-12 ">
					<label id="Specs" data-toggle="collapse" data-target="#demo">Especifica√ß√µes  </label><i id="Caret" class="fa fa-caret-right CaretRight" aria-hidden="true"></i>
					<div id="demo" class="collapse">
						<ul class="list-group">
							<li class="list-group-item">Especifica√ß√£o 1</li>
							<li class="list-group-item">Especifica√ß√£o 2</li>
							<li class="list-group-item">Especifica√ß√£o 3</li>
							<li class="list-group-item">Especifica√ß√£o 4</li>
							<li class="list-group-item">Especifica√ß√£o 5</li>
							<li class="list-group-item">Especifica√ß√£o 6</li>
						</ul>
					</div>
				</div>
			</div>
							...
							<select class="form-control">
								...
								<!--<div id="estado" class="wrapper-dropdown estado" tabindex="1">
									...
									<ul class="select-dropdown">
										...
										<li><a href="#"><i class="icon-plane icon-large"></i>S„o Paulo</a></li>
									</ul>
								</div>-->
						...
						<div class="form-group col-md-4" >
							...
							<!--<div id="cidade" class="wrapper-dropdown estado" tabindex="1">
								...
								<ul class="select-dropdown">
									...
									<li><a href="#"><i class="icon-truck icon-large"></i>Sabar·</a></li>
